...
public class ReviewController(IReviewService reviewService) : ControllerBase
{
    ...
    {
        var review = await reviewService.CreateAsync(reviewDto);
    ...
    {
        var review = await reviewService.DeleteAsync(id);
    ...
    {
        var topBooks = await reviewService.GetTopRatedBooksReviews();
